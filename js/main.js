...
var mainState = {
  ...
  preload: function () {
    //This functin will execute at the beginning of the game
    //Here we'll load all of our assets (art, music, ect)   
  ...
  update: function () {
    ...
    if (this.bird.inWorld == false) {
      ...
      addOnePipe: function (x,y) {
       ...
       jump: function () {
        //Let's add velocity to the bird when the spacebar is pressed down
